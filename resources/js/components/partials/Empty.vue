<template>
    <div class="bg-90 flex flex-col items-center justify-center" style="min-height: 300px">
        <svg
        ...
        <h1 class="text-white text-4xl text-90 font-light mb-6">
            Laravel Nova Mediable Manager
        </h1>

        <p class="text-white-50% text-lg">
            There is no any Media!
            <code @click="$emit('show-uploader')" class=" cursor-pointer ml-1 border border-80 text-sm font-mono text-white bg-black rounded px-2 py-1">
                Open Uploader to add some
            </code>
        </p>
    </div>
</template>